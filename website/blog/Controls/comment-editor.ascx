...
<fieldset id="comment-editor">
    ...
    <br />
           <tinymce:TextArea ID="comment_text" theme="advanced" plugins="safari" 
                theme_advanced_buttons1="bold,italic,underline,fontsizeselect,bullist,numlist,undo,redo,link,unlink,image,cleanup,formatselect"
