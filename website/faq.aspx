...
<asp:Content ID="default" ContentPlaceHolderID="body" runat="server">
    ...
    <p>
        ...
        and allows you to delete key mappings by clicking the Delete column.</p>
    <br />
    <p>
    ...
    <br />
    <p>
        If you have multiple keyboards installed, the displayed keyboard should be the same
    ...
    <br />
    <p>
        To install them, first you need to open "Regional and Language Options" in Windows'
        Control Panel, select the Languages tab, and check both "Install files for complex
        script and right-to-left languages ..." and "Install files for East Asian languages".
        The required files will be installed when you click OK or Apply so have your CD
        (or the path to your i386 folder) handy, and you'll need to restart your computer.</p>
    <h3 class="question" runat="server">
    ...
    <p>
        ...
        understands. The format is documented <a href="http://www.microsoft.com/whdc/archive/w2kscan-map.mspx">
            here</a>, although the fact that you can have per-user mappings in Windows XP or
        later isn't documented.</p>
    <br />
    <p>
        When Windows starts (or when you log in, for per-user mappings) , it reads the registry
        to see what keys should be disabled and what substitutions should be made.
    </p>
    <h3 class="question" runat="server">
    ...
    <br />
    <p>
        Pause is thus remapped to Alt-F4, the shortcut used to close programs (or if the
    ...
    <br />
    <p>
        Other combinations you can use:<br />
    ...
    <h3 class="question" runat="server">
        ...
        original keys!</h3>
    <p>
        This functionality will have to wait for a future version. Alternatively, try the
        <a href="http://www.thinkgeek.com/computing/input/9836/">Optimus Maximus keyboard</a>
        (Thanks to Steve Ward for this question.)</p>
    </form>
</asp:Content>
