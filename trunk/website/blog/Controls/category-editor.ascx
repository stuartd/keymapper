<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="category-editor.ascx.cs" Inherits="category_editor" %>
            ...
            <ol>
                <li>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCategoryName"
                       ...
                       <asp:CustomValidator runat="server" ID="CategoryNameExistsValidator" 
                        ErrorMessage="That category name is already used: please choose another" 
                        ControlToValidate="txtCategoryName" 
                        onservervalidate="CategoryNameExistsValidator_ServerValidate"></asp:CustomValidator></li>
                <li>
                ...
                <li>
                    The category slug will be generated automatically if left blank. It can only 
                    contain letters, numbers, and hyphens.</li>
            </ol>
