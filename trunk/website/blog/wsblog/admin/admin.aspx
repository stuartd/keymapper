<%@ Page Language="C#" MasterPageFile="~/KMBlog.Master" AutoEventWireup="true" CodeFile="admin.aspx.cs" Inherits="BlogAdmin" Title="Administrative Page" %>


<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
<form id="pageform" runat="server">
    <h4 id="header">
        Key Mapper Blog Admin</h4>
        <ul class="topnav">
