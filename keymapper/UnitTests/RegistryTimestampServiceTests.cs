...
namespace KeyMapper.UnitTests
{
    ...
    internal class RegistryTimestampServiceTests
    {
        ...
        public void Can_Access_All_Hives()
        {
            ...
            // One per hive.
            DateTime dt = registryTimestampService.GetRegistryKeyTimestamp(RegistryHive.ClassesRoot, "*");
        ...
        public void Non_Existing_Keys_Return_Minvalue()
        {
            ...
            DateTime dt = registryTimestampService.GetRegistryKeyTimestamp(RegistryHive.DynData, "foo_bar_baz");
        ...
        {
            DateTime dt = registryTimestampService.GetRegistryKeyTimestamp(RegistryHive.CurrentUser, "Volatile Environment");
            Assert.AreNotEqual(DateTime.MinValue, dt);
